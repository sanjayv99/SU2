...
void CConfig::SetPointersNull() {
  ...
  Marker_CfgFile_Deform_Mesh_Slide   = nullptr;  Marker_All_Deform_Mesh_Slide   = nullptr;
  Marker_CfgFile_Deform_Mesh_IL   = nullptr;  Marker_All_Deform_Mesh_IL   = nullptr;
  ...
  Marker_Deform_Mesh          = nullptr;    Marker_Deform_Mesh_Sym_Plane= nullptr;
  Marker_Deform_Mesh_Slide    = nullptr;    Marker_Deform_Mesh_IL       = nullptr;    Marker_Fluid_Load          = nullptr;
...
void CConfig::SetConfig_Options() {
 ...
 /* DESCRIPTION: default value for AIR */
  ...
  /*!\brief MARKER_DEFORM_MESH_SLIDE\n DESCRIPTION: Sliding marker for mesh deformation only \ingroup Config*/
  addStringListOption("MARKER_DEFORM_MESH_SLIDE", nMarker_Deform_Mesh_Slide, Marker_Deform_Mesh_Slide);
    /*!\brief MARKER_DEFORM_MESH_SLIDE\n DESCRIPTION: Sliding marker for mesh deformation only \ingroup Config*/ // TODO -  
  addStringListOption("MARKER_DEFORM_MESH_IL", nMarker_Deform_Mesh_IL, Marker_Deform_Mesh_IL);
...
void CConfig::SetMarkers(SU2_COMPONENT val_software) {
  ...
  iMarker_Fluid_Load, iMarker_Deform_Mesh, iMarker_Deform_Mesh_Sym_Plane, iMarker_Deform_Mesh_Slide, iMarker_Deform_Mesh_IL,
  ...
  Marker_All_Deform_Mesh_Slide = new unsigned short[nMarker_All] (); //Store wheter the boundary will follow the deformation
  Marker_All_Deform_Mesh_IL = new unsigned short[nMarker_All] (); //Store wheter the boundary will follow the deformation // TODO -  
  ...
  Marker_CfgFile_Deform_Mesh_Slide = new unsigned short[nMarker_CfgFile] ();
  Marker_CfgFile_Deform_Mesh_IL = new unsigned short[nMarker_CfgFile] ();
  ...
  for (iMarker_CfgFile = 0; iMarker_CfgFile < nMarker_CfgFile; iMarker_CfgFile++) {
    Marker_CfgFile_Deform_Mesh_Slide[iMarker_CfgFile] = NO;
    for (iMarker_Deform_Mesh_Slide = 0; iMarker_Deform_Mesh_Slide < nMarker_Deform_Mesh_Slide; iMarker_Deform_Mesh_Slide++)
      if (Marker_CfgFile_TagBound[iMarker_CfgFile] == Marker_Deform_Mesh_Slide[iMarker_Deform_Mesh_Slide])
        Marker_CfgFile_Deform_Mesh_Slide[iMarker_CfgFile] = YES;
  }

  for (iMarker_CfgFile = 0; iMarker_CfgFile < nMarker_CfgFile; iMarker_CfgFile++) {
    Marker_CfgFile_Deform_Mesh_IL[iMarker_CfgFile] = NO;
    for (iMarker_Deform_Mesh_IL = 0; iMarker_Deform_Mesh_IL < nMarker_Deform_Mesh_IL; iMarker_Deform_Mesh_IL++)
      if (Marker_CfgFile_TagBound[iMarker_CfgFile] == Marker_Deform_Mesh_IL[iMarker_Deform_Mesh_IL])
        Marker_CfgFile_Deform_Mesh_IL[iMarker_CfgFile] = YES;
  }
...
void CConfig::SetOutput(SU2_COMPONENT val_software, unsigned short val_izone) {
  ...
  iMarker_Deform_Mesh, iMarker_Deform_Mesh_Sym_Plane, iMarker_Deform_Mesh_Slide, iMarker_Deform_Mesh_IL,
  ...
  if (nMarker_Deform_Mesh_Slide!= 0) {
    BoundaryTable << "Sliding mesh boundary";
    for (iMarker_Deform_Mesh_Slide = 0; iMarker_Deform_Mesh_Slide < nMarker_Deform_Mesh_Slide; iMarker_Deform_Mesh_Slide++) {
      BoundaryTable << Marker_Deform_Mesh_Slide[iMarker_Deform_Mesh_Slide];
      if (iMarker_Deform_Mesh_Slide < nMarker_Deform_Mesh_Slide-1)  BoundaryTable << " ";
    }
    BoundaryTable.PrintFooter();
  }
  // TODO -  add IL markers
...
unsigned short CConfig::GetMarker_CfgFile_Deform_Mesh_Slide(const string& val_marker) const {
  unsigned short iMarker_CfgFile;
  for (iMarker_CfgFile = 0; iMarker_CfgFile < nMarker_CfgFile; iMarker_CfgFile++)
    if (Marker_CfgFile_TagBound[iMarker_CfgFile] == val_marker) break;
  return Marker_CfgFile_Deform_Mesh_Slide[iMarker_CfgFile];
}

unsigned short CConfig::GetMarker_CfgFile_Deform_Mesh_IL(const string& val_marker) const {
  unsigned short iMarker_CfgFile;
  for (iMarker_CfgFile = 0; iMarker_CfgFile < nMarker_CfgFile; iMarker_CfgFile++)
    if (Marker_CfgFile_TagBound[iMarker_CfgFile] == val_marker) break;
  return Marker_CfgFile_Deform_Mesh_IL[iMarker_CfgFile];
}
...
CConfig::~CConfig() {
  ...
  delete[] Marker_CfgFile_Deform_Mesh_Slide;
  delete[] Marker_All_Deform_Mesh_Slide;

  delete[] Marker_CfgFile_Deform_Mesh_IL;
  delete[] Marker_All_Deform_Mesh_IL;
...
unsigned short CConfig::GetMarker_Deform_Mesh_Slide(const string& val_marker) const {
  unsigned short iMarker;

  /*--- Find the marker for this internal boundary. ---*/
  for (iMarker = 0; iMarker < nMarker_Deform_Mesh_Slide; iMarker++)
    if (Marker_Deform_Mesh_Slide[iMarker] == val_marker) break;
  return iMarker;
}
// TODO -  update docs
unsigned short CConfig::GetMarker_Deform_Mesh_IL(const string& val_marker) const {
  unsigned short iMarker;

  /*--- Find the marker for this internal boundary. ---*/
  for (iMarker = 0; iMarker < nMarker_Deform_Mesh_IL; iMarker++)
    if (Marker_Deform_Mesh_IL[iMarker] == val_marker) break;
  return iMarker;
}
