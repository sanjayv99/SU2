...
void CConfig::SetPointersNull() {
  ...
  Marker_Deform_Mesh_Slide    = nullptr;    Marker_Fluid_Load           = nullptr;
...
void CConfig::SetMarkers(SU2_COMPONENT val_software) {
  ...
  iMarker_Fluid_Load, iMarker_Deform_Mesh, iMarker_Deform_Mesh_Sym_Plane, iMarker_Deform_Mesh_Slide,
...
void CConfig::SetOutput(SU2_COMPONENT val_software, unsigned short val_izone) {
  ...
  iMarker_Deform_Mesh, iMarker_Deform_Mesh_Sym_Plane, iMarker_Deform_Mesh_Slide,
